...
#ifndef EVRMORE_QT_GUIUTIL_H
#define EVRMORE_QT_GUIUTIL_H
...
/** Utility functions used by the Evrmore Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "evrmore:" URI into recipient object, return true on successful parsing
